...
public class CriaMonstro : MonoBehaviour
{
    ...
    private void Start()
    {
        InvokeRepeating(nameof(SpawnEsqueleto), tempoEsqueleto, tempoEsqueleto);
        InvokeRepeating(nameof(SpawnLagarto), tempoLagarto, tempoLagarto);
        InvokeRepeating(nameof(SpawnGolem), tempoGolem, tempoGolem);
    }
